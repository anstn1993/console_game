...
public class 공격효과스레드 implements Runnable {
	
	String type;//생성자에 어떤 공격효과메소드를 불러올지 정하기 위한 변수
	공격효과스레드(String type){//생성자에 입력된 타입에 따라 공격 효과 메소드가 결정됨
		this.type=type;
		
	}
	//---------------모험가 공격 효과--------------------------------------------	
		public void 모험가공격() {
			String[] 모험가공격이미지=new String[7];
	   ...
	   모험가공격이미지[6]="                                                                      .                                                              \n"+
			...
			for(int i=0; i<모험가공격이미지.length; i++ ) {
				for(int j=0;j<30;j++) {
					System.out.println("");
				}
				System.out.println(모험가공격이미지[i]);
				try {
					Thread.sleep(120);
		...
		public void 모험가스킬() {
			...
			for(int i=0; i<모험가스킬이미지.length; i++ ) {
				for(int j=0;j<50;j++) {
					System.out.println("");
				}
				System.out.println(모험가스킬이미지[i]);
				try {
					Thread.sleep(120);
				} catch (InterruptedException e) {
	...
	모험가궁극기이미지[2]="             i.  .r:                    \n"+
	 ...
	 모험가궁극기이미지[8]="                                                                                                                         i.  .r:                    \n"+
			...
			for(int i=0; i<모험가궁극기이미지.length; i++ ) {
				for(int j=0;j<50;j++) {
					System.out.println("");
				}
				System.out.println(모험가궁극기이미지[i]);
				try {
					Thread.sleep(120);
				} catch (InterruptedException e) {
	...
	//-----------------------------보스 공격 효과---------------------------------	
		public void 보스공격() {
			String[] 보스공격이미지=new String[34];
			
			보스공격이미지[0]="                                                                                                                               .          ::";
			보스공격이미지[1]="                                                                                                                            :.          7j: ";
			보스공격이미지[2]="                                                                                                         :i.             .rr.        .1gL.  ";
			보스공격이미지[3]="                                                                                                  .::.:vji.            iIJ:    ..  .qBP.    ";
			보스공격이미지[4]="                                                                                               .:s1sjEKr       ::.   rZI:  .:2dL.idBQ:      ";
			보스공격이미지[5]="                                                                                            .:vPQgMRP:      :7Y:  . :L. ..7RBM7rMBBr.       ";
			보스공격이미지[6]="                                                                                         .:7SQBBQBU:     .rK2i  :r.   :ivgBBUuQBBJ..        ";
			보스공격이미지[7]="                                                                                      .:72MBBBBgs.  . .:5DS: .7sr.:iUZgRBBRPBBBI:.          ";
			보스공격이미지[8]="                                                                                    .rJdRBBBREv:.....vEQ2:.ijXs7vXgBBBBBBgQBBbi.            ";
			보스공격이미지[9]="                                                                                 .:vqZMDZbDPji....i2QMU::rSKS2PMBBBRRRQgMQBMu:.             ";
			보스공격이미지[10]="                                                                               .rIPDdqIXdE2Yr::i7PggJiisSKIPZRMMgMZgDgEDgBgU:.              ";
			보스공격이미지[11]="                                                                            .:JqEq5ss1DgqjL77vUPDP177uXU1KQDbPPEPPgZbKdgBRJ.                ";
			보스공격이미지[12]="                                                                          .7SDq2L7r2gQXJsIUUuSSSsLY221YSDgS5IXXPdgKXIZMQqr.                 ";
			보스공격이미지[13]="                                                                       .ijdPI7r:ijgDULXDEUvv1uY7vLjvvJKbSJuu12bPXuUXdZEj:                   ";
			보스공격이미지[14]="                                                                     :7PZK7i:.:2gQUYqBguirY2J7iririrvUbqYYLjIK1sLU5S5qv:                    ";
			보스공격이미지[15]="                                                                  .i5DEYi:..rEBQBZQBDv..iJX52vrrrirrqQSr77Jus7vvuLJSqr.                     ";
			보스공격이미지[16]="                                                                .vdQ5r...:sQBBSJ15Y:.  rbBQDvvsYrirKg7:rr777r7r7ruE2:.                      ";
			보스공격이미지[17]="                                                              iUQDJ. ....i7i. :ii.  .vBBBg7.:iir7rjB2.iiririri:rPb7.                        ";
			보스공격이미지[18]="                                                           .rZBZi   ...... .:r:   .SBBB5:   :72Jr7Db.::::i::::JgU:                          ";
			보스공격이미지[19]="                                                        .:UQBI.       ... ...   iRBBBr    :2gX7:r2r...:::::.iPZr.                           ";
			보스공격이미지[20]="                                                      .7PBMv         ...      jBBBS.    idQPr:.ii.YQ..... .1g1.                             ";
			보스공격이미지[21]="                                                    :sQBK.        iBBB5.   .gQBBr     vZQ5r...:..IBi ..  igPi                               ";
			보스공격이미지[22]="                                                 .iKBQL     .r:.2BBB5.   7BBBq.    .jgPvi: ... .LBE     IQv.                                ";
			보스공격이미지[23]="                                              ..vdBDr     sRBMdBBBi    PBQBr     .KgI:. .:... .igB.   rRP:                                  ";
			보스공격이미지[24]="                                             .7bQEi    .2RKvrIQZ.   :BBBP.     rEMY.         .:PQ:   bM7.                                   ";
			보스공격이미지[25]="                                            .sgqi    iEgu::rqS.   1BBQL      YRb7.           .1E:  7BI:                                     ";
			보스공격이미지[26]="                                           .LQX   .UgZ7..:7K.  .DBBB.     .KRK:.            .rPr .PEi.                                      ";
			보스공격이미지[27]="                                          .rDY  :bB5i   .i2. iBBBg.     rEMJ:              .:7X.:PY.                                        ";
			보스공격이미지[28]="                                         .i2i iEDu:    .:j7rQBBX      LRdv.                .:1jr7:                                          ";
			보스공격이미지[29]="                                        .:s7ruUi.      .riLPBS   .7:JDqi.                  .ri...                                           ";
			보스공격이미지[30]="                                        .vri::         ..:vPv  rZPvuv:                                                                      ";
			보스공격이미지[31]="                                        ..              .rUr.iKIr..                                                                         ";
			보스공격이미지[32]="                                                       :7jrirr.                                                                             ";
			보스공격이미지[33]="                                                      .ii....                                                                               ";
			...
			for(int i=0; i<보스공격이미지.length; i++ ) {
				System.out.println(보스공격이미지[i]);
				try {
					Thread.sleep(10);
				} catch (InterruptedException e) {
		...
		public void 보스스킬() {
			...
			for(int i=0; i<보스스킬이미지.length; i++ ) {
				for(int j=0;j<50;j++) {
					System.out.println("");
				}
				System.out.println(보스스킬이미지[i]);
				try {
					Thread.sleep(120);
				} catch (InterruptedException e) {
		...
		public void 보스궁극기() {
			...
			for(int i=0; i<보스궁극기이미지.length; i++ ) {
				for(int j=0;j<50;j++) {
					System.out.println("");
				}
				System.out.println(보스궁극기이미지[i]);
				try {
					Thread.sleep(120);
				} catch (InterruptedException e) {
	...
	//-------------------몬스터 공격 효과---------------------------------------------------	
		...
		public void 몬스터공격() {
			...
			for(int i=0; i<몬스터공격이미지.length; i++ ) {
				for(int j=0;j<50;j++) {
					System.out.println("");
				}
				System.out.println(몬스터공격이미지[i]);
				try {
					Thread.sleep(120);
				} catch (InterruptedException e) {
	...
	@Override
	public void run() {//생성자를 통해서 지정해준 type에 따라서 공격 효과가 결정됨
		switch(type) {
			case "모험가공격"://type에 '모험가공격'을 넣으면 모험가공격() 호출
				this.모험가공격();
				break;
			case "모험가스킬"://type에 '모험가스킬'을 넣으면 모험가스킬() 호출
				this.모험가스킬();
				break;
			case "모험가궁극기"://type에 '모험가궁극기'를 넣으면 모험가궁극기() 호출
				this.모험가궁극기();
				break;
			case "보스공격"://type에 '보스공격'을 넣으면 보스공격() 호출
				this.보스공격();
				break;
			case "보스스킬"://type에 '보스스킬'을 넣으면 보스스킬() 호출
				this.보스스킬();
				break;
			case "보스궁극기"://type에 '보스궁극기'를 넣으면 보스궁극기() 호출
				this.보스궁극기();
				break;
			case "몬스터공격"://type에 '몬스터공격'을 넣으면 몬스터공격() 호출
				this.몬스터공격();
				break;
		}
	}	
